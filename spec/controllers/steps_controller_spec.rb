  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved step as @step" do
        ...
        post :create, {:step => { "description" => "invalid value" }}, valid_session
        assigns(:step).should be_a_new(Step)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested step" do
        ...
        Step.any_instance.should_receive(:update).with({ "description" => "MyString" })
        put :update, {:id => step.to_param, :step => { "description" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the step as @step" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Step.any_instance.stub(:save).and_return(false)
        put :update, {:id => step.to_param, :step => { "description" => "invalid value" }}, valid_session
        assigns(:step).should eq(step)
      end
