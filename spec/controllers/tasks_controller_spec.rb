  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved task as @task" do
        ...
        post :create, {:task => { "project_id" => "invalid value" }}, valid_session
        assigns(:task).should be_a_new(Task)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested task" do
        ...
        Task.any_instance.should_receive(:update).with({ "project_id" => "1" })
        put :update, {:id => task.to_param, :task => { "project_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the task as @task" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Task.any_instance.stub(:save).and_return(false)
        put :update, {:id => task.to_param, :task => { "project_id" => "invalid value" }}, valid_session
        assigns(:task).should eq(task)
      end
